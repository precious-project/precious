Precious Core version 0.13.3 is now available from:

  <https://download.precious.org/precious-0.13.3/>
...
Precious Core now supports P2SH addresses beginning with M on mainnet and Q on testnet.
