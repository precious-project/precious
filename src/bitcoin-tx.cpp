...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s precious-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  precious-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded precious transaction") + "\n" +
              "  precious-tx [options] -create [commands]   " + _("Create hex-encoded precious transaction") + "\n" +
              "\n";
