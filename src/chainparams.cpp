...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.precious.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("precioustools.com", "dnsseed.precioustools.com"));
        vSeeds.push_back(CDNSSeedData("preciouspool.org", "dnsseed.preciouspool.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("precioustools.com", "testnet-seed.precioustools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.precious.loshan.co.uk", true));
