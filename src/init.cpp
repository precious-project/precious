...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/precious-project/precious>";
    const std::string URL_WEBSITE = "<https://precious.org>";
